...
const Services = () => {
  return (
    <section className="mx-auto container p-4">
      <a href="http://177.136.204.56:180/totem/" target="_blank">
        <ul className="flex flex-wrap gap-4 relative -mt-10 z-10">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((val, i) => (
            <li
              key={i}
              className="flex flex-col justify-around rounded sm:flex-row items-center bg-white-50 w-36 md:w-80 md:h-fit flex-grow px-2 py-4 md:p-4 shadow"
            >
