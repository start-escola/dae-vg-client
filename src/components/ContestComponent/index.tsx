    ...
    <div className="flex flex-col bg-grey w-full rounded border drop-shadow border-border_grey text-primary-500">
      ...
      <div className="p-4 md:p-5">
            ...
            process_number && (
              <li className="flex justify-between items-center p-4 bg-white-50 border rounded border-border_grey">
                <Image
                  ...
                  className="mr-5"
                />
                <Text className="text-primary-500 text-base md:text-xl" as="span">
            ...
            realization && (
              <li className="flex justify-between items-center p-4 bg-white-50 text-primary-500 border rounded text-base md:text-xl border-border_grey">
                <Image
                  ...
                  className="mr-5"
                />
                <Text className="text-primary-500 text-base md:text-xl">
        ...
        <div className="flex flex-col">
          ...
          >
            {isExpanded ? <Text as="strong" className="text-primary-500">Ler menos</Text> : <Text as="strong" className="text-primary-500">...ler mais</Text>}
          </button>
        </div>
        <div className="flex justify-start items-center mb-2">
          <Image src="/download.svg" width={18} height={18} alt="download" />
          <Text className="text-base text-primary-500 ml-2">
              ...
              {files.map(({ url, name }) => (
                ...
                >
                  ...
                  >
                    ...
                    <Text className="text-border_grey text-base mt-1">{name.length > 13 ? `${name.substring(0, 10)}...` : name}</Text>
                  </a>
                </li>
              ))}
            </ul>
